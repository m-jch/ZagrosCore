...
@section('title')
    {{$project->name}} - {{$project->milestone->codename}} - {{trans('ZagrosCore::layout.cnbug')}}
@stop

@section('menu-mid')
    <li class="active"><a>{{trans('ZagrosCore::layout.cnbug')}}</a></li>
@stop

@section('content')
    <div class="col-md-6 col-md-offset-3">
        <h2 class="text-center">{{trans('ZagrosCore::layout.cnbug')}}</h2>
