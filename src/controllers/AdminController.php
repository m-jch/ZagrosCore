...
class AdminController extends BaseController
{
    ...
    {
        return View::make('ZagrosCore::admin.create-project');
    }
    ...
    public function postCreateProject()
    {
        ...
        $project->url = Helper::slug(Input::get('name'));
    ...
    public function getUpdateProject($id = null)
    {
        ...
        if ($project)
        {
            ...
            return View::make('ZagrosCore::admin.update-project')->with(array(
                'project' => $project,
                'admins' => $admins,
                'writers' => $writers,
                'readers' => $readers
    ...
    {
        return View::make('ZagrosCore::admin.create-user');
    }
    ...
    public function getUpdateUser($userId)
    {
        ...
        return View::make('ZagrosCore::admin.update-user', array(
            'user' => $user
        ));
    }
    ...
    public function getDeleteUser($userId)
    {
        ...
        return View::make('ZagrosCore::admin.delete-user', array(
            'user' => $user,
            'users' => $users
        ));
    }
    ...
    public function getUsersList()
    {
        ...
        return View::make('ZagrosCore::admin.users-list', array(
            'users' => $users,
