...
class ProjectController extends BaseController
{
    ...
    public function getIndex($projectUrl)
    {
        ...
        return View::make('ZagrosCore::project.milestone.list')->with(array(
            'project' => $project
        ));
    }
    ...
    public function getCreate($projectUrl)
    {
        ...
        return View::make('ZagrosCore::project.milestone.create')->with(array(
            'project' => $project
        ));
    }
    ...
    public function postCreate($projectUrl)
    {
        ...
        $milestone->url = Helper::slug(Input::get('codename'));
    ...
    public function getEdit($projectUrl, $id)
    {
        ...
        return View::make('ZagrosCore::project.milestone.edit')->with(array(
            'project' => $project,
            'milestone' => $milestone
        ));
    }
